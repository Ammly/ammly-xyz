        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8">
            ...
            <header className="mb-8 space-y-4">
              ...
              {/* Social Sharing */}
              <ShareButtons postUrl={postUrl} shareText={shareText} shareUrl={shareUrl} variant="inline" />
            </header>
          ...
          <aside className="hidden lg:block lg:col-span-4">
            <div className="sticky top-24 space-y-6">
              ...
              <Card className="p-6">
                ...
                <ShareButtons postUrl={postUrl} shareText={shareText} shareUrl={shareUrl} variant="card" />
              </Card>
            </div>
          </aside>
        </div>
