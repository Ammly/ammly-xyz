...
endDate: "Oct 2024"
current: false
description: "Designed and maintained distributed systems serving millions of users across Value-Added Services (VAS) platforms. Led migration to cloud-native architecture and implemented high-availability solutions."
achievements:
  - "Architected microservices platform serving millions of users with 99.9% uptime"
...
Led the design and development of Value-Added Services (VAS) platform infrastructure serving millions of users with mission-critical services.
